...
export const styles: Record<string, React.CSSProperties> = {
  ...
  languageItemActive: { width: "100%", display: "flex", alignItems: "center", gap: 16, padding: "18px 20px", background: "#fff5f5", border: "none", cursor: "pointer", transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)", color: "#222", textAlign: "left", transform: "scale(1.02)" },
  languageIconCircle: { width: 48, height: 48, borderRadius: "50%", background: "#f8f8f8", display: "flex", alignItems: "center", justifyContent: "center", color: "#e74c3c", flexShrink: 0 },
  ...
  orderTypeItemActive: { width: "100%", display: "flex", alignItems: "center", gap: 16, padding: "20px", background: "#fff5f5", border: "2px solid #e74c3c", borderRadius: 16, cursor: "pointer", transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)", marginBottom: 12, textAlign: "left", transform: "scale(1.02)", boxShadow: "0 4px 12px rgba(231, 76, 60, 0.15)" },
  orderTypeIcon: { width: 48, height: 48, borderRadius: 12, background: "#f8f8f8", display: "flex", alignItems: "center", justifyContent: "center", color: "#e74c3c", flexShrink: 0 },
  ...
  branchItemActive: { width: "100%", display: "flex", alignItems: "center", gap: 16, padding: "18px 20px", background: "#fff5f5", border: "none", borderBottom: "1px solid #f5f5f5", cursor: "pointer", transition: "all 0.3s cubic-bezier(0.4, 0, 0.2, 1)", color: "#222", textAlign: "left", transform: "translateX(4px)" },
  branchIcon: { width: 44, height: 44, borderRadius: 12, background: "#f8f8f8", display: "flex", alignItems: "center", justifyContent: "center", color: "#e74c3c", flexShrink: 0 },
