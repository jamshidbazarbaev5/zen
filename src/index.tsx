...
const MOCK_PRODUCTS: Product[] = [
  { id: 1, name: "KIDS COMBO", price: 73000, category: "Kombo", image: combo1, description: "Mini burger Pops Kids sok Super qahramon Sousni mijozning ko'ngliga qarab tanlash imkoniyat bor" },
  { id: 2, name: "KAMTAR COMBO", price: 35000, category: "Kombo", image: combo1, description: "Hot-dog kartoshka fri va ichimlik bilan" },
  { id: 3, name: "OILAVIY COMBO", price: 120000, category: "Kombo", image: combo1, description: "2 ta burger, 2 kartoshka fri, 2 ichimlik" },
  { id: 4, name: "MEGA COMBO", price: 95000, category: "Kombo", image: combo1, description: "Katta burger, kartoshka fri, ichimlik va desert" },
  { id: 5, name: "CLASSIC LAVASH", price: 28000, category: "Lavash", image: combo1, description: "Go'sht, sabzavotlar va maxsus sous bilan" },
  { id: 6, name: "CHICKEN LAVASH", price: 32000, category: "Lavash", image: combo1, description: "Tovuq go'shti, sabzavotlar va sarimsoqli sous" },
  { id: 7, name: "CLASSIC BURGER", price: 25000, category: "Burger", image: combo1, description: "Go'sht kotleti, pishloq, salat va pomidor" },
  { id: 8, name: "DOUBLE BURGER", price: 40000, category: "Burger", image: combo1, description: "Ikki go'sht kotleti, ikki pishloq, salat" },
  { id: 9, name: "CLASSIC HOT-DOG", price: 18000, category: "Xot-dog", image: combo1, description: "Sosiska, gorchitsa va ketchup bilan" },
  { id: 10, name: "DOUBLE HOT-DOG", price: 25000, category: "Xot-dog", image: combo1, description: "Ikki sosiska va maxsus sous bilan" },
  { id: 11, name: "COCA-COLA 0.5L", price: 8000, category: "Senchalar", image: combo1, description: "Sovuq Coca-Cola 0.5 litr" },
  { id: 12, name: "FANTA 0.5L", price: 8000, category: "Senchalar", image: combo1, description: "Sovuq Fanta 0.5 litr" },
];
    ...
    <div style={styles.container}>
      ...
      <div style={styles.profileRow}>
        ...
        <div style={styles.deliveryToggle}>
          ...
          >
            Olib ketish <ChevronDownIcon />
          </button>
        </div>
        <div style={{ textAlign: "center", fontSize: 12, color: "#666" }}>01 Algoritm - Feed up</div>
          ...
          <div style={styles.menuPanel} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={styles.menuList}>
              ...
              <div style={styles.menuItemRow}>
                ...
                <span style={{ fontSize: 15, color: "#999" }}>O'zbekcha</span>
              </div>
              <div style={styles.menuDivider} />
              <div style={styles.menuItemRow}>
